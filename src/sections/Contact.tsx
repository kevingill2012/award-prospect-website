      ...
      <div className="mx-auto max-w-7xl px-6">
        ...
        <div className="mt-16 grid gap-12 lg:grid-cols-2 items-stretch">
          ...
          >
            ...
            <div className="flex flex-col items-center justify-center rounded-xl border border-white/8 bg-white/[0.03] p-6">
              <h4 className="mb-3 text-center font-semibold">{tr("contact.whatsapp.title", lang)}</h4>
              ...
              <a
                ...
                className="mt-3 inline-flex items-center gap-2 rounded-full bg-green-500 px-5 py-2.5 text-sm font-semibold text-white transition-shadow hover:shadow-[0_0_20px_rgba(34,197,94,0.4)]"
              >
